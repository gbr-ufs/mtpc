...
Como LLMs são uma nova e popular tecnologia \citeonline{openai_funding_2025}, torna-se necessário medir o impacto que o seu uso pode causar. Seja desde ao consumo de eletricidade \citeonline{10748289}, até, como foco deste artigo, o aprendizado \citeonline{10983758}. Neste trabalho, será avaliado o impacto destas ferramentas para a aprendizagem de programação, mediante uma pesquisa com os discentes ingressantes do período 2025.1. Isso auxiliará no momento de decisão dos docentes, quando forem organizar o que irão fazer a respeito do uso destas tecnologiasp para as novas matérias da reformulação da grade, \textit{viz.} ``Programação A'', ``Programação B'' e ``Programação C''.
Os Large Language Models (LLMs), como o ChatGPT e o Gemini, são modelos de Inteligência Artificial Generativa treinados em volumes massivos de dados textuais. Isso proporciona uma notável multifuncionalidade e rapidez na execução de tarefas complexas, como gerar textos, criar códigos e resumir informações \citeonline{google_global_2025}). Embora sua arquitetura se baseie nos transformers, essa tecnologia experimentou um crescimento exponencial em popularidade no meio acadêmico a partir de 2023, devido à alta acessibilidade e à eficácia das soluções imediatas que oferece \citeonline{jensen_generative_2025}. A rápida ascensão dos LLMs como ferramenta onipresente é especialmente crítica, pois a facilidade de obter soluções prontas — sobretudo em atividades de codificação --- atrai estudantes de programação, redefinindo o processo de aprendizado. Diante disso, surgem questionamentos sobre a necessidade urgente de adaptação curricular para proteger e garantir o desenvolvimento fundamental do raciocínio lógico \citeonline{gan_large_2023}.

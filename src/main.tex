...
No estudo \textcite{xie2024integrating}, a amostra foi composta, majoritariamente, por estudantes de graduação matriculados no curso de Ciência da Computação e afins, com níveis iniciais de experiência em programação, em uma universidade norte-americana. O estudo realizou uma pesquisa empírica de abordagem quantitativa, baseada em experimentos educacionais em disciplinas introdutórias de programação.  O objetivo do trabalho foi analisar como estudantes percebem o uso de ferramentas de IA generativa no apoio à programação e avaliar sua capacidade de identificar e corrigir erros em códigos gerados por IA. Os estudantes participaram de atividades práticas, nas quais realizaram tarefas de análise e depuração de códigos gerados por IA. Os resultados apontam que, embora os alunos demonstrem alta aceitação e percebam ganhos de produtividade, muitos apresentam dificuldades significativas na depuração e compreensão conceitual do código produzido pela IA. Como lacunas, o estudo reconhece que a amostra está restrita a um contexto cultural, o que limita a generalização dos resultados para o contexto brasileiro.
\postextual

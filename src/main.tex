...
Ferramentas digitais são onipresentes \textcites{cornelio_historia_2021}, com destaque para a Inteligência Artificial (IA), devido à multifuncionalidade, podendo realizar uma ampla variedade de tarefas diferentes, e rapidez \textcites{google_global_2025}. No meio acadêmico, o uso dessas ferramentas gera incertezas. A utilização inconsequente de LLMs traz riscos como a dependência criativa e decisória, limitando o desenvolvimento crítico dos universitários \textcites{marrOs15Maiores2023}.

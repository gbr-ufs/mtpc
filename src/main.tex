...
Atualmente, ferramentas digitais são onipresentes \textcites{cornelio_historia_2021}, com destaque para a Inteligência Artificial (IA), devido à multifuncionalidade e rapidez \textcites{google_global_2025}. No meio acadêmico, o uso dessas ferramentas gera incertezas. A utilização inconsequente de LLMs traz riscos como a dependência criativa e decisória, limitando o desenvolvimento crítico dos universitários \textcites{marrOs15Maiores2023}.
...
A evolução do Aprendizado de Máquina para lidar com dados de alta complexidade e não-linearidade fundamenta-se no desenvolvimento das Redes Neurais Artificiais (RNAs). Inspiradas biologicamente no funcionamento do sistema nervoso central, as RNAs tiveram gênese teórica estabelecida por \textcites{mcculloch_logical_1943}, que propuseram o primeiro modelo matemático de um neurônio artificial. Nesse modelo, a unidade de processamento recebe múltiplos sinais de entrada, pondera-os através de pesos sinápticos e aplica uma função de ativação para determinar a saída. Embora os modelos iniciais fossem limitados em capacidade de representação, o desenvolvimento do algoritmo de \textit{backpropagation} (retropropagação) permitiu o ajuste eficiente desses pesos em redes com múltiplas camadas, viabilizando o aprendizado supervisionado complexo \textcites{rumelhartLearningRepresentationsBackpropagating1986}.

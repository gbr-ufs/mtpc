...
O objetivo geral deste artigo é de buscar uma forma de integrar a IA na educação dessas disciplinas, em conjunto com os professores, visando potenciar o ensino assistido por tecnologia sem comprometer o desenvolvimento do raciocínio crítico e a autonomia dos estudantes.
...
\item Investigar a correlação entre a complexidade dos problemas de programação propostos e a recorrência ao uso de ferramentas generativas. % Especificar.
\end{enumerate}

...
\hypersetup{
  ...
  pdfkeywords={universidade federal de sergipe}{inteligencia artificial}{educação},
  colorlinks=true,
  linkcolor=blue,
  citecolor=blue,
  filecolor=magenta,
...
% Espaçamento.
% Mantive 3cm em tudo conforme seu código original (se for regra da UFS).
% Se quiser padrão ABNT estrito, mude os segundos valores para 2cm.
